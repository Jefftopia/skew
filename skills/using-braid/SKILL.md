...
name: using-braid
description: >-
  How to correctly use the Braid packages (@braidlabs/core, @braidlabs/gateway,
  @braidlabs/angular, @braidlabs/react, @braidlabs/cli) to compose independently deployed frontend
...
| Host a fragment in an Angular app | `@braidlabs/angular`: `provideBraid()` + `<braid-fragment>` |
| Host a fragment in a React app | `@braidlabs/react`: `initBraidReact()` + `<BraidFragment>` |
...
| Run it all locally | `braid dev` from `@braidlabs/cli` |
