 ...
 * app.config.ts
 *
 * Wires @braidlabs/angular-router chunk recovery into the standalone app config.
 *
 ...
 *     (skew-manifest.json, emitted by @braidlabs/build) with cache: 'no-store' and
