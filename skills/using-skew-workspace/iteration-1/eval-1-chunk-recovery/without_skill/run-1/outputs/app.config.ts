 ...
 * app.config.ts
 *
 * Wires @skew/angular-router chunk recovery into the standalone app config.
 *
 ...
 *     (skew-manifest.json, emitted by @skew/build) with cache: 'no-store' and
