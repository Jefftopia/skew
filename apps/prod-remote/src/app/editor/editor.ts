...
import { isSkewDisabled, registerSchema } from '@braidlabs/skew';
...
import { runSchema } from '@braidlabs/angular-workflow';
import {
  DRAFT_KEY,
  DraftSchemaV2,
  type DraftV2,
...
export class Editor {
  ...
  /** Mirrors the host's switch — the flag lives in the shared `@braidlabs/skew`. */
  ...
  private async handleCommand(
    ...
    switch (action) {
      ...
      case 'register-schema': {
        ...
        // bundles reach through the one shared @braidlabs/skew instance. From this
