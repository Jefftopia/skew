...
import { isSkewDisabled, setSkewDisabled } from '@braidlabs/skew';
...
export class Lab {
  ...
  /**
   * Mirrors the flag in `@braidlabs/skew` rather than owning it.
   *
  ...
  toggle(): void {
    ...
    this.write(
      ...
      'mode',
      next
        ? 'Protections OFF — @braidlabs is inert. Envelopes, migrations, retries and recovery all stand down.'
