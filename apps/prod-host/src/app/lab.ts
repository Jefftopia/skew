...
import { isSkewDisabled, setSkewDisabled } from '@braid/skew';
...
export class Lab {
  ...
  /**
   * Mirrors the flag in `@braid/skew` rather than owning it.
   *
  ...
  toggle(): void {
    ...
    this.write(
      ...
      'mode',
      next
        ? 'Protections OFF — @braid is inert. Envelopes, migrations, retries and recovery all stand down.'
