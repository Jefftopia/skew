...
import { defineWorkflow } from '@skew/angular-workflow';
 ...
 * Both sides declare their own understanding of that envelope, and `@skew/core`
 ...
 * Version 1.
 *
 * Records written before `@skew/core` was adopted carry no envelope at all;
