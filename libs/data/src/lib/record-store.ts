import type { SkewResult, VersionedEnvelope, VersionedSchema } from '@braidlabs/skew';
 ...
 *
 * Every value is **enveloped** by `@braidlabs/skew` on the way in and projected on the way out.
