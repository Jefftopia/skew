import { createOutbox, type Outbox, type RecordDriver } from '@skewkit/data';
 ...
 *
 * The queue itself is `@skewkit/data`'s outbox rather than a second implementation: one record per
