import type { DiscoveryEntry, DiscoveryPage, FragmentManifest } from '@skewkit/braid-gateway';
import type { DescriptorNote, RegistryDiff, RegistryFinding, SnapshotRef } from '@skewkit/braid-registry';
